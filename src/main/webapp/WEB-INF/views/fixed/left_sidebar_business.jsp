		...
		<div class="slimscroll-menu">
			...
			<ul class="metismenu side-nav">
				...
				<li class="side-nav-item"><a href="#" class="side-nav-link">
						...
						class="badge badge-success float-right">1</span> <span> 오늘 일정 목록 </span>
				</a></li>

				<li class="side-nav-item"><a href="#" class="side-nav-link">
						<i class="dripicons-list"></i> <span> 새로 추가된 목록 </span>
				</a></li>
				...
				<li class="side-nav-item"><a href="#" class="side-nav-link">
						<i class="dripicons-document"></i> <span> 서비스 관리 </span>
				</a></li>

				<li class="side-nav-item"><a href="#" class="side-nav-link">
						<i class="dripicons-graph-pie"></i> <span> 직원 관리 </span>
				</a></li>

				<li class="side-nav-item"><a href="#" class="side-nav-link">
						<i class="dripicons-graph-pie"></i> <span> 고객 관리 </span>
				</a></li>
