...
<div id=wrapper>
	<div id="workingTime">
	<hr/>
		<div id="workingTime"><h5 class="text-success">영업 시간</h5>
			<div id="weekday">평일(월~금): <span id="weekdayTime"> </span> </div>
			<div id="sat">토요일: <span id="satTime"> </span> </div>
			<div id="sun">일요일: <span id="sunTime"> </span> </div>
			<div id="hld">공휴일: <span id="hldTime"> </span> </div>
			<div id="lch">점심시간: <span id="lchTime"> </span> </div>
			<div id="extra">기타 휴무일: <span id="extraDay"> </span> </div>
		</div>
	</div>
	<hr/>
	<div id="tag">
	...
	<div id="location">
		...
		<span id="address"> </span> <span id="addr">${bus_addr} </span> <span id="addr2">${bus_addr2}</span>
	</div>
	<br/>
	
	<div id="map" style="width:350px; height:250px;">
	</div>
