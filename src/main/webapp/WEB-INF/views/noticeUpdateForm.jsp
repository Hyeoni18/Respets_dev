				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<form action="noticeUpdate" name="noticeUpdateForm"
										method="get">
										<div class="form-group mb-3">
											<label for="example-select">카테고리</label> <select
												class="form-control" name="abc_no" id="abc_no">
										...
										<div class="form-group">
											<label for="simpleinput">제목</label> <input type="text"
												...
												placeholder="게시글 제목을 입력하세요" value="${abo.abo_title}">
										</div>
										<div class="form-group">
											<label for="simpleinput">내용</label>
											<textarea data-toggle="maxlength" class="form-control"
												maxlength="1000" rows="10" name="abo_ctt"
												placeholder="게시글 내용을 입력하세요">${abo.abo_ctt}</textarea>
										</div>
										<input type="hidden" name="abo_no" value="${abo.abo_no}">
										<div style="text-align: right">
											<button id="noticeUpdateSubmit"
