...
<script>
	$(document).ready(function() {
		...
		$("#pty_no option").each(function(){
			if($(this).val()=="${pet.pty_no}") $(this).attr("selected", "selected");
		})
		$("#pet_sex option").each(function(){
			if($(this).val()=="${pet.pet_sex}")	$(this).attr("selected", "selected");
		})
		$("#pet_ntr option").each(function(){
			if($(this).val()=="${pet.pet_ntr}")	$(this).attr("selected", "selected");
		})
		$("#pet_tot option").each(function(){
			if($(this).val()=="${pet.pet_tot}") $(this).attr("selected", "selected");
		})
	});
