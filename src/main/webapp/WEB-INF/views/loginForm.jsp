                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
        						...
        						<div class="form-group">
        							<a href="./findMyIdForm" class="text-muted float-right"><small>아이디 찾기</small></a>
        							<label for="password">비밀번호</label>
        							<input class="form-control" type="password" id="pw" name="pw" placeholder="Enter your password">
        						</div>
       								 <div class="form-group mb-3">
                                        <div class="custom-control custom-checkbox">
                                            <label class="custom-control-label" for="checkbox-signin"></label>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">계정이 없으십니까? <a href='./joinChoiceForm' class="text-dark ml-1">
                                	<b>회원가입</b>
                                 </a>
                                </p>
                            </div> <!-- end col -->
...
${updateMyPw} <!--현휘; 비밀번호 변경이 완료됐다는 안내 alert -->
<!-- App js -->
